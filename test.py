...
#  data folder
parser.add_argument('-data', type=str, default='../data/liver/TestData/volume-', help='test images')
parser.add_argument('-liver_path', type=str, default='../data/liver/TestData/segmentation-')
